...
public final class SequentialBehaviorDebug extends SequentialBehavior implements DebuggableBehavior
{
    ...
    public SequentialBehaviorDebug(final GoalStep goalStep, final Method method, final Method method2, final boolean b, final String s, final short n, final int n2, final Object[] array, final __StepDesc[] array2, final __BehaviorDesc behaviorDesc) {
        super(goalStep, method, method2, b, s, n, n2, array, array2);
        this.debugSupport = new BehaviorDebugSupport(this, ((DebuggableStep)this.parent).getNestLevel());
        this.behaviorDesc = behaviorDesc;
    }
    
    public SequentialBehaviorDebug(final GoalStep goalStep, final Method method, final Method method2, final boolean b, final String s, final short n, final int n2, final Object[] array, final __StepDesc[] array2, final BehavingEntity[] array3, final __BehaviorDesc behaviorDesc) {
        super(goalStep, method, method2, b, s, n, n2, array, array2, array3);
        this.debugSupport = new BehaviorDebugSupport(this, ((DebuggableStep)this.parent).getNestLevel());
        this.behaviorDesc = behaviorDesc;
    }
}
