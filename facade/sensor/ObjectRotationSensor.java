...
public class ObjectRotationSensor extends FacadeSensor implements SpriteID
{
    ...
    protected boolean changed(final int p0, final Point3D p1) {
        ...
        //     5: athrow         
        //     6: aload_0        
        //     7: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //    10: dup            
        //    11: astore_3       
        //    12: monitorenter   
        //    13: aload_0        
        //    14: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
    ...
    public void senseOneShot(final Object[] array) {
        if (array != null && array.length > 0) {
            ...
            NativeAnimationInterface.getObjectRotation(intValue, point3D);
            this.deleteOldWMEs(intValue);
            BehavingEntity.getBehavingEntity().addWME(new ObjectRotationWME(intValue, point3D.x, point3D.y, point3D.z));
        }
        else {
            final ObjectSensePacket objectSensePacket = new ObjectSensePacket();
            NativeAnimationInterface.getAllObjectRotations(objectSensePacket);
    ...
    private final void addAllRotationWMEs(final ObjectSensePacket objectSensePacket) {
        for (int i = 0; i < objectSensePacket.info.length; ++i) {
            BehavingEntity.getBehavingEntity().addWME(new ObjectRotationWME(objectSensePacket.info[i].objectID, objectSensePacket.info[i].x, objectSensePacket.info[i].y, objectSensePacket.info[i].z));
        }
    }
    
    private final synchronized void deleteOldWMEs(final int n) {
        final Object[] array = BehavingEntity.getBehavingEntity().lookupWME("ObjectRotationWME").toArray();
        for (int i = 0; i < array.length; ++i) {
            if (((ObjectRotationWME)array[i]).getObjectID() == n) {
    ...
    public void initializeContinuous(final Object[] p0) {
        ...
        //    37: iload_3        
        //    38: aload_2        
        //    39: invokestatic    facade/nativeinterface/NativeAnimationInterface.getObjectRotation:(ILfacade/util/Point3D;)V
        //    42: aload_0        
        //    43: iload_3        
        //    44: invokespecial   facade/sensor/ObjectRotationSensor.deleteOldWMEs:(I)V
        //    47: invokestatic    abl/runtime/BehavingEntity.getBehavingEntity:()Labl/runtime/BehavingEntity;
        //    50: new             Lfacade/characters/wmedef/ObjectRotationWME;
        //    53: dup            
        //    54: iload_3        
        //    55: aload_2        
        //    56: getfield        facade/util/Point3D.x:F
        ...
        //    67: invokespecial   facade/characters/wmedef/ObjectRotationWME.<init>:(IFFF)V
        ...
        //    79: athrow         
        //    80: aload_0        
        //    81: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //    84: dup            
        //    85: astore          5
        //    87: monitorenter   
        //    88: aload_0        
        //    89: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //    92: aload           4
        //    94: invokevirtual   java/util/Hashtable.remove:(Ljava/lang/Object;)Ljava/lang/Object;
        //    97: pop            
        //    98: aload_0        
        //    99: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //   102: aload           4
        //   104: aload_2        
        ...
        //   122: astore_2       
        //   123: aload_2        
        //   124: invokestatic    facade/nativeinterface/NativeAnimationInterface.getAllObjectRotations:(Lfacade/util/ObjectSensePacket;)V
        //   127: aload_0        
        //   128: invokespecial   facade/sensor/ObjectRotationSensor.deleteAllOldWMEs:()V
        //   131: aload_0        
        //   132: aload_2        
        //   133: invokespecial   facade/sensor/ObjectRotationSensor.addAllRotationWMEs:(Lfacade/util/ObjectSensePacket;)V
        //   136: aload_0        
        //   137: aload_2        
        //   138: invokespecial   facade/sensor/ObjectRotationSensor.updateLastRotations:(Lfacade/util/ObjectSensePacket;)V
        //   141: return         
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type
    ...
    private final void updateLastRotations(final ObjectSensePacket p0) {
        ...
        //    36: astore          5
        //    38: aload_0        
        //    39: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //    42: aload           5
        //    44: invokevirtual   java/util/Hashtable.remove:(Ljava/lang/Object;)Ljava/lang/Object;
        //    47: pop            
        //    48: aload_0        
        //    49: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //    52: aload           5
    ...
    private final void updateLastRotationsConditionally(final ObjectSensePacket p0) {
        ...
        //    50: aload_3        
        //    51: invokevirtual   facade/sensor/ObjectRotationSensor.changed:(ILfacade/util/Point3D;)Z
        //    54: ifeq            161
        //    57: aload_0        
        //    58: aload_1        
        //    59: getfield        facade/util/ObjectSensePacket.info:[Lfacade/util/ObjectSensePacket$ObjectSenseInfo;
        ...
        //    67: invokespecial   facade/sensor/ObjectRotationSensor.deleteOldWMEs:(I)V
        //    70: invokestatic    abl/runtime/BehavingEntity.getBehavingEntity:()Labl/runtime/BehavingEntity;
        //    73: new             Lfacade/characters/wmedef/ObjectRotationWME;
        //    76: dup            
        //    77: aload_1        
        ...
        //    98: invokespecial   facade/characters/wmedef/ObjectRotationWME.<init>:(IFFF)V
        ...
        //   110: athrow         
        //   111: aload_0        
        //   112: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //   115: dup            
        //   116: astore          4
        //   118: monitorenter   
        ...
        //   135: astore          6
        //   137: aload_0        
        //   138: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //   141: aload           6
        //   143: invokevirtual   java/util/Hashtable.remove:(Ljava/lang/Object;)Ljava/lang/Object;
        //   146: pop            
        //   147: aload_0        
        //   148: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //   151: aload           6
        //   153: aload_3        
    ...
    public void senseContinuous(final Object[] p0) {
        ...
        //    43: iload_3        
        //    44: aload_2        
        //    45: invokevirtual   facade/sensor/ObjectRotationSensor.changed:(ILfacade/util/Point3D;)Z
        //    48: ifeq            121
        //    51: aload_0        
        //    52: iload_3        
        //    53: invokespecial   facade/sensor/ObjectRotationSensor.deleteOldWMEs:(I)V
        //    56: invokestatic    abl/runtime/BehavingEntity.getBehavingEntity:()Labl/runtime/BehavingEntity;
        //    59: new             Lfacade/characters/wmedef/ObjectRotationWME;
        //    62: dup            
        //    63: iload_3        
        //    64: aload_2        
        ...
        //    76: invokespecial   facade/characters/wmedef/ObjectRotationWME.<init>:(IFFF)V
        ...
        //    88: athrow         
        //    89: aload_0        
        //    90: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //    93: dup            
        //    94: astore          5
        //    96: monitorenter   
        //    97: aload_0        
        //    98: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //   101: aload           4
        //   103: invokevirtual   java/util/Hashtable.remove:(Ljava/lang/Object;)Ljava/lang/Object;
        //   106: pop            
        //   107: aload_0        
        //   108: getfield        facade/sensor/ObjectRotationSensor.lastRotations:Ljava/util/Hashtable;
        //   111: aload           4
        //   113: aload_2        
        ...
        //   131: astore_2       
        //   132: aload_2        
        //   133: invokestatic    facade/nativeinterface/NativeAnimationInterface.getAllObjectRotations:(Lfacade/util/ObjectSensePacket;)V
        //   136: aload_0        
        //   137: aload_2        
        //   138: invokespecial   facade/sensor/ObjectRotationSensor.updateLastRotationsConditionally:(Lfacade/util/ObjectSensePacket;)V
        //   141: return         
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type
    ...
    public synchronized void addSpecificRotationWME(final int n) {
        final Object[] array = BehavingEntity.getBehavingEntity().lookupWME("ObjectRotationWME").toArray();
        ObjectRotationWME objectRotationWME = null;
        for (int i = 0; i < array.length; ++i) {
            if (((ObjectRotationWME)array[i]).getObjectID() == n) {
                objectRotationWME = (ObjectRotationWME)array[i];
                break;
            }
        }
        if (objectRotationWME != null) {
            switch (n) {
                case 2: {
                    BehavingEntity.getBehavingEntity().deleteAllWMEClass("PlayerRotationWME");
                    BehavingEntity.getBehavingEntity().addWME(new PlayerRotationWME(objectRotationWME.getX(), objectRotationWME.getY(), objectRotationWME.getZ()));
                    break;
                }
            }
        }
