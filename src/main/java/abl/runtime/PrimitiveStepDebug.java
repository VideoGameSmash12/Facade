...
{
    final void execute() {
        ((DebuggableBehavior)this.parent).traceAblExecutionEvent(5, this, null, this.getNestLevel());
        super.execute();
    }
    
    final void succeedStep() {
        ((DebuggableBehavior)this.parent).traceAblExecutionEvent(6, this, new Boolean(true), this.getNestLevel());
        super.succeedStep();
    }
    
    final void failStep() {
        ((DebuggableBehavior)this.parent).traceAblExecutionEvent(6, this, new Boolean(false), this.getNestLevel());
        super.failStep();
    }
