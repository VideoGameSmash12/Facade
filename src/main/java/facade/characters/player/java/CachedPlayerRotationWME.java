...
public class CachedPlayerRotationWME extends WME
{
    private float x;
    private float y;
    private float z;
    ...
    public CachedPlayerRotationWME(final float x, final float y, final float z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
    
    public CachedPlayerRotationWME() {
    }
}
