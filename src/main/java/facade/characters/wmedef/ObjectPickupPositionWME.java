...
public class ObjectPickupPositionWME extends WME
{
    ...
    public ObjectPickupPositionWME(final int objectID, final int characterID, final float x, final float y, final float z) {
        this.objectID = objectID;
        this.characterID = characterID;
        this.x = x;
        this.y = y;
    ...
    public ObjectPickupPositionWME() {
    }
}
