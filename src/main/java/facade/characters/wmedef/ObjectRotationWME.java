...
public class ObjectRotationWME extends WME
{
    ...
    public ObjectRotationWME(final int objectID, final float x, final float y, final float z) {
        this.objectID = objectID;
        this.x = x;
        this.y = y;
        this.z = z;
