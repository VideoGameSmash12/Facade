...
public class PrevStagingInfoWME extends WME
{
    ...
    public PrevStagingInfoWME(final int resourcePriority, final int targetObjectID, final float targetX, final float targetZ, final float targetRot, final int walkType) {
        this.resourcePriority = resourcePriority;
        this.targetObjectID = targetObjectID;
        this.targetX = targetX;
        this.targetZ = targetZ;
