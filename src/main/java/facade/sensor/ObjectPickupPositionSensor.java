...
public abstract class ObjectPickupPositionSensor extends FacadeSensor implements SpriteID
{
    ...
    protected boolean changed(final int p0, final int p1, final Point3D p2) {
        ...
        //     6: athrow         
        //     7: aload_0        
        //     8: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //    11: dup            
        //    12: astore          4
        //    14: monitorenter   
        //    15: iload_1        
        ...
        //    28: istore          7
        //    30: aload_0        
        //    31: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
    ...
    protected void senseOneShot_Utility(final int n) {
        ...
        NativeAnimationInterface.getAllObjectPickupPositions(n, objectSensePacket);
        this.deleteAllOldWMEs(n);
        this.addAllPickupPositionWMEs(n, objectSensePacket);
    }
    
    private final synchronized void deleteAllOldWMEs(final int n) {
        final Object[] array = BehavingEntity.getBehavingEntity().lookupWME("ObjectPickupPositionWME").toArray();
        for (int i = 0; i < array.length; ++i) {
            if (((ObjectPickupPositionWME)array[i]).getCharacterID() == n) {
    ...
    private final synchronized void deleteOldWMEs(final int n, final int n2) {
        final Object[] array = BehavingEntity.getBehavingEntity().lookupWME("ObjectPickupPositionWME").toArray();
        for (int i = 0; i < array.length; ++i) {
            if (((ObjectPickupPositionWME)array[i]).getObjectID() == n && ((ObjectPickupPositionWME)array[i]).getCharacterID() == n2) {
                BehavingEntity.getBehavingEntity().deleteWME((WME)array[i]);
            }
        }
    }
    
    private final void addAllPickupPositionWMEs(final int n, final ObjectSensePacket objectSensePacket) {
        for (int i = 0; i < objectSensePacket.info.length; ++i) {
            BehavingEntity.getBehavingEntity().addWME(new ObjectPickupPositionWME(objectSensePacket.info[i].objectID, n, objectSensePacket.info[i].x, objectSensePacket.info[i].y, objectSensePacket.info[i].z));
        }
    }
    ...
    protected void initializeContinuous_Utility(final int n) {
        ...
        this.deleteAllOldWMEs(n);
        this.addAllPickupPositionWMEs(n, objectSensePacket);
        this.updateLastPickupPositions(objectSensePacket);
    }
    
    private final void updateLastPickupPositions(final ObjectSensePacket p0) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //     5: athrow         
        //     6: aload_0        
        //     7: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //    10: dup            
        //    11: astore_2       
        //    12: monitorenter   
        //    13: iconst_0       
        ...
        //    36: astore          5
        //    38: aload_0        
        //    39: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //    42: aload           5
        //    44: invokevirtual   java/util/Hashtable.remove:(Ljava/lang/Object;)Ljava/lang/Object;
        //    47: pop            
        //    48: aload_0        
        //    49: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //    52: aload           5
    ...
    private final void updateLastPickupPositionsConditionally(final int p0, final ObjectSensePacket p1) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //    51: iload_1        
        //    52: aload           4
        //    54: invokevirtual   facade/sensor/ObjectPickupPositionSensor.changed:(IILfacade/util/Point3D;)Z
        //    57: ifeq            170
        //    60: aload_0        
        //    61: aload_2        
        ...
        //    70: iload_1        
        //    71: invokespecial   facade/sensor/ObjectPickupPositionSensor.deleteOldWMEs:(II)V
        //    74: invokestatic    abl/runtime/BehavingEntity.getBehavingEntity:()Labl/runtime/BehavingEntity;
        //    77: new             Lfacade/characters/wmedef/ObjectPickupPositionWME;
        //    80: dup            
        //    81: aload_2        
        ...
        //   106: invokespecial   facade/characters/wmedef/ObjectPickupPositionWME.<init>:(IIFFF)V
        ...
        //   118: athrow         
        //   119: aload_0        
        //   120: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //   123: dup            
        //   124: astore          5
        //   126: monitorenter   
        ...
        //   143: astore          7
        //   145: aload_0        
        //   146: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //   149: aload           7
        //   151: invokevirtual   java/util/Hashtable.remove:(Ljava/lang/Object;)Ljava/lang/Object;
        //   154: pop            
        //   155: aload_0        
        //   156: getfield        facade/sensor/ObjectPickupPositionSensor.lastPositions:Ljava/util/Hashtable;
        //   159: aload           7
        //   161: aload           4
    ...
    protected void senseContinuous_Utility(final int n) {
        final ObjectSensePacket objectSensePacket = new ObjectSensePacket();
        NativeAnimationInterface.getAllObjectPickupPositions(n, objectSensePacket);
        this.updateLastPickupPositionsConditionally(n, objectSensePacket);
    }
    ...
    public ObjectPickupPositionSensor() {
        this.this();
    }
}
